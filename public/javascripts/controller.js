...
app.controller('PostsController', ['$scope','$http','$location',function($scope,$http,$location)
{
	...
	$scope.Logout=function() {
		$http({
	        url: "https://whispering-waters-22556.herokuapp.com/users/logout",
	        method: "GET"
	    })
	    .then(function(response) {
	...
	$scope.Search=function() {
		$http({
	        url: "https://whispering-waters-22556.herokuapp.com/posts/search",
	        method: "POST",
	    ...
	    .then(function(response) {
			...
			if($("input[type='file']")[0].files.length>0) {
				$.ajax({
			        ...
			        url: 'https://whispering-waters-22556.herokuapp.com/postimages',
			        type: 'POST',
			        // Form data
			        data: data,
